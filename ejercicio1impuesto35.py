...
class Empleado(Persona):
    ...
    def pagar_impuestos(self):
        if self.sueldo > 3600000:
          porsentaje= self.sueldo*0.35
          repor= self.sueldo - porsentaje
          print("El empleado debe pagar retefuente que vendira siendo un 35% por lo tanto el empleado gana." , repor , "ya que se le desconto" , porsentaje , "de su sueldo que era de" , self.sueldo )
        else:
